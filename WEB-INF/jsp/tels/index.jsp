...
<!-- $Id: index.jsp 3036 2010-12-14 02:03:38Z honchikun@gmail.com $ -->
<!--
...
<div id="centeredDiv" class="homePageMask"> 
	...
	<div id="contentTop">
		<div id="boxWelcome" class="panelColor1 panel">
            ...
            <!--birchstart-->
            <div class="header">The WISE Tour</div>
            ...
            <table width="634">
            	<tr>
            		<td>
					      ...
					      <li><a class="welcomeLink">Overview</a></li>
                        </ul>                    </td>
                    <td>
                   		<ul id="welcomeTextLinks">
                        	<li><a class="welcomeLink">Student Engagement</a></li>
                        </ul>                    </td>
                    <td>
                    	<ul id="welcomeTextLinks">
							<li><a class="welcomeLink">Engineering Design</a></li>
                        </ul>                    </td>
                    <td rowspan="2">	
                    	<ul id="largewelcomeTextLinks">	
                            <li><a href="signup.html" class="welcomeLink">Get Started!</a></li>
				  </ul>                   </td>
                </tr>
                <tr>
                	<td>
                    	<ul id="welcomeTextLinks">
							<li><a class="welcomeLink">Curriculum Based</a></li>
                        </ul>                    </td>
                    <td>
                    	<ul id="welcomeTextLinks">
                        	<li><a class="welcomeLink">Teacher Tools</a></li>
                        </ul>                    </td>
                    <td>
                    	<ul id="welcomeTextLinks">
							<li><a class="welcomeLink">View Projects</a></li>
                        </ul>                    </td>
                </tr>
                    </ul>
                    </table>
			...
			<div id="signInSub1" class="panelColor2 panel signinSub"><!--  SignIn Sub Box 1-->
				...
				<form id="home" method="post" action="j_acegi_security_check" autocomplete="off">
					...
					<div class="alignRight">
						<input type="submit" id="signInlink" value="Sign In &raquo;" />
    	...
    	<div id="signInSub2">
			<div class="panelColor1 panel">
                ...
                <div class="alignRight">
					<p id="newsArchivelink">
						<a href="./newsarchive.html">View all news &raquo;</a>
						</a>
					</p>
				</div>
			</div>
