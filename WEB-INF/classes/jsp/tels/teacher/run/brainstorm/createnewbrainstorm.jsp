...
<script type="text/javascript">
	...
	function submit(){
		...
		if(type=='OPEN_RESPONSE'){
			window.location.href='createopenresponsebrainstorm.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT&runId=${runId}';
		}else if(type=='SINGLE_CHOICE'){
			window.location.href='createsinglechoicebrainstorm.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT&runId=${runId}';
