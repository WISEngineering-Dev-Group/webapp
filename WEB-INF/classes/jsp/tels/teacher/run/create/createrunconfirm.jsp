...
<script type="text/javascript">
	...
	function runCleaning(allowed){
		...
		document.getElementById('cleaningFrm').src = '../../author/authorproject.html?command=launchAuthoring&param1=cleanProject&projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT';
	...
	function sendCleanMessage(){
		...
		if('${project.metadata}' && '${project.metadata.title}'){
			...
			var projectName = 'SAIL Web Application';
		};
		*/

		var projectName = '<c:out value="SAIL Web Application" />';
		
		var body = 'Hello, I am ${currentUsername} and would like to request a cleaning for the project ' + projectName +
				' with project ID net.sf.sail:webapp:war:0.1.0-SNAPSHOT so that I may set up a run with this project. Thank you.';
