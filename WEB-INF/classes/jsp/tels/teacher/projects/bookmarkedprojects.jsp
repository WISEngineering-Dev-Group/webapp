...
<table id="projectOverviewTable">
		...
		<td class="actions" colspan="6"> 
				<ul>
					...
					<li><a href="<c:url value="../run/createRun.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Set up as Project Run</a></li>
					<li><a href="#" onclick="copy('net.sf.sail:webapp:war:0.1.0-SNAPSHOT','${project.projectType}','SAIL Web Application','${filenameMap[project.id]}','${urlMap[project.id]}','${curriculumBaseDir}')" >Create copy in <i>My Custom-Authored</i></a></li>
