				...
				<c:set var="projectNameEscaped" value="${projectNameEscapedMap[project.id]}" />
					<table id="projectOverviewTable">
							...
							<td id="titleCell" colspan="3">
									<a href="../projectinfo.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">SAIL Web Application</a>
							...
							<td class="actions" colspan="8"> 
									<ul>
										<li><a href="<c:url value="../../../previewproject.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Preview</a></li>
										<li><a href="../projectinfo.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">Project Info</a></li>
										<li><a href="<c:url value="../../run/createRun.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Set up Project Run</a></li>
										<li><a href="../../../author/authorproject.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">Edit/Author</a></li>
										<li><a href="shareproject.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">Share</a>
										<li><a href="#" onclick="copy('net.sf.sail:webapp:war:0.1.0-SNAPSHOT','${project.projectType}','<c:out value="${projectNameEscaped}" />','${filenameMap[project.id]}','${urlMap[project.id]}','${curriculumBaseDir}')" >Copy</a></li>
										<li><a href="#" style="color:#666;">Archive</a>
										<!-- input type='checkbox' id='public_net.sf.sail:webapp:war:0.1.0-SNAPSHOT' onclick='changePublic("net.sf.sail:webapp:war:0.1.0-SNAPSHOT")'/> Is Public</li>-->
									</ul>
							</tr>
								<tr id="row2">
							...
							<tr id="row3">
								<td class="dataCell libraryProjectSmallText">net.sf.sail:webapp:war:0.1.0-SNAPSHOT</td>       		   
							...
							<tr id="row4">  
								<td colspan="9">
									<a id="hideShowLink" href="#" onclick="toggleDetails(net.sf.sail:webapp:war:0.1.0-SNAPSHOT)">Hide/Show project details</a>
									<div id="details_net.sf.sail:webapp:war:0.1.0-SNAPSHOT">
...
<div id="customProjectInstructions">The projects below have been shared with you by another user.</div>
	...
	<table id="projectOverviewTable">
							<c:forEach var="project" items="${currentSharedProjectsList}">
								...
								<tr id="row1">
								<td id="titleCell" colspan="3">
										<a href="../projectinfo.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT"><c:out value="SAIL Web Application" /></a>
										<c:if test="${fn:length(project.sharedowners) > 0}">
								...
								<td class="actions" colspan="8"> 
										<ul>
											...
											<li><a href="../../../previewproject.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">Preview Project</a></li>
											<li><a href="../projectinfo.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">Project Info</a></li>
											<li><a href="<c:url value="../../run/createRun.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Set up Project Run</a></li>
											...
											<sec:accesscontrollist domainObject="${project}" hasPermission="16">												
												<li><a href="shareproject.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">Share</a></li>
											</sec:accesscontrollist>										
											<li><a href="#" style="color:#666;">Archive</a>
											<!-- input type='checkbox' id='public_net.sf.sail:webapp:war:0.1.0-SNAPSHOT' onclick='changePublic("net.sf.sail:webapp:war:0.1.0-SNAPSHOT")'/> Is Public</li>-->
										</ul>
		...
		<c:otherwise>
			...
			<c:forEach var="project" items="${bookmarkedProjectsList}">
				<c:choose>
					...
					<c:otherwise>
						<c:set var="projectName" value="SAIL Web Application"/>
					</c:otherwise>
				</c:choose>

			<table id="projectOverviewTable">
					<tr id="row1">
					<td id="titleCell" colspan="3"><a href="../projectinfo.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT">SAIL Web Application</a></td>
					<td class="actions" colspan="6"> 
							<ul>

								<li><a href="#" onclick="unbookmark(net.sf.sail:webapp:war:0.1.0-SNAPSHOT)">Unbookmark</a></li>
								<li><a href="<c:url value="../../../previewproject.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Preview</a></li>
								<li><a href="<c:url value="../../run/createRun.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Set up Project Run</a></li>
								<li><a href="#" onclick="copy('net.sf.sail:webapp:war:0.1.0-SNAPSHOT','${project.projectType}','SAIL Web Application','${filenameMap[project.id]}','${urlMap[project.id]}','${curriculumBaseDir}')" >Copy to <i>My Projects</i></a></li>
