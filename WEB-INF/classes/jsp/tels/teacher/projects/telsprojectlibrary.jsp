...
<script type="text/javascript">
	...
	function bookmarked(){
		...
		<c:forEach var='project' items='${projectList}'>
			...
			if(bookmarked){
				document.getElementById('check_net.sf.sail:webapp:war:0.1.0-SNAPSHOT').checked = true;
			};
		</c:forEach>
	};
...
<c:forEach var="project" items="${projectList}">
	...
	<table id="projectOverviewTable">
		...
		<td class="actions" colspan="7"> 
				<ul>
					<li><input type="checkbox" id="check_net.sf.sail:webapp:war:0.1.0-SNAPSHOT" onclick="javascript:bookmark('net.sf.sail:webapp:war:0.1.0-SNAPSHOT')"/><label for="check_net.sf.sail:webapp:war:0.1.0-SNAPSHOT"><a href="#">Bookmark</a></label></li>
					<li><a target=_blank href="<c:url value="../../previewproject.html"><c:param name="projectId" value="net.sf.sail:webapp:war:0.1.0-SNAPSHOT"/></c:url>">Preview</a></li>
					...
					<li><a href="#" onclick="copy('net.sf.sail:webapp:war:0.1.0-SNAPSHOT','${project.projectType}','<c:out value="${projectNameEscaped}" />','${filenameMap[project.id]}','${urlMap[project.id]}','${curriculumBaseDir}')" >Copy to <i>My Projects</i></a></li>
					...
					<tr id="row2">
							...
							<tr id="row4">  
								<td colspan="9">
									<a id="hideShowLink" onclick="toggleDetails(net.sf.sail:webapp:war:0.1.0-SNAPSHOT)">Hide/Show project details</a>
									<div id="details_net.sf.sail:webapp:war:0.1.0-SNAPSHOT" style="display:none;">
