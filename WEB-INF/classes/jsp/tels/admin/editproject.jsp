...
<form:form method="post" action="editproject.html?projectId=net.sf.sail:webapp:war:0.1.0-SNAPSHOT" 
	commandName="project" id="editproject" autocomplete='off'>
    <br/><br/>
	<b>Projecd Id:</b><form:label path="id"></form:label> net.sf.sail:webapp:war:0.1.0-SNAPSHOT<br/><br/>
